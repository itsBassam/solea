...
export const services = sqliteTable(
  ...
  (table) => [
    ...
    index('idx_services_status_sort').on(table.status, table.sortOrder),
  ],
);
...
export const daysOff = sqliteTable(
  'days_off',
  {
    id: text('id').primaryKey(),
...
export const messages = sqliteTable(
  ...
  (table) => [
    index('idx_messages_customer_created').on(
      table.customerId,
      table.createdAt,
    ),
    index('idx_messages_status_schedule').on(table.status, table.scheduledFor),
  ],
);
...
export const notes = sqliteTable(
  ...
  (table) => [
    index('idx_notes_customer_created').on(table.customerId, table.createdAt),
  ],
);
